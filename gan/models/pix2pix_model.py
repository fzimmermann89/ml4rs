...
class Pix2PixModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['real_A', 'fake_B', 'real_B', 'pred_real', 'pred_fake']
    ...
    def backward_D(self):
        ...
        # self.dist_pred_real_fake = torch.dist(self.pred_real, self.pred_fake,2)
